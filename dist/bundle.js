...
module.exports = React.createClass({
  ...
  getCurrentDropdown: function getCurrentDropdown(style) {
    if (!this.state.isFocused) {
      return false;
    }if (this.state.value) {
      return React.createElement(
        "div",
        { className: "search__dropdown search__dropdown--autocomplete", style: style },
        "autocomplete"
      );
    } else {
      return React.createElement(
        "div",
        { className: "search__dropdown search__dropdown--suggestions", style: style },
        "suggestions"
      );
    }
  },
  ...
  render: function render() {
    ...
    return React.createElement(
      "div",
      { className: "search", style: searchStyle },
      React.createElement(
        "input",
        {
...
var SearchBox = _interopRequire(require("./components/search-box"));

React.render(React.createElement(SearchBox, null), document.getElementById("main"));

},{"./components/search-box":1,"react":158}],3:[function(require,module,exports){
